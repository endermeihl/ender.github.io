...
def time_run(cmdline):
    ...
    for _ in range(NUM_RUNS):
        start = time.time()
        subprocess.run(cmdline, shell=True,stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
programs = [
    ...
    # ('Python', 'python3 20210512/simple.py', 'python3 20210512/optimized.py', ''),
    ('Python', 'python3 20210512/simple.py', 'python3 20210512/optimized.py', ''),
